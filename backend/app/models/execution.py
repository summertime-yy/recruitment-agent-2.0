...
class Execution(Base, TimestampMixin):
    ...
    execution_id: Mapped[str] = mapped_column(String(50), primary_key=True, default=generate_execution_id)
    ...
    step_id: Mapped[str | None] = mapped_column(String(50), nullable=True, comment="对应 PlanStep.step_id")
