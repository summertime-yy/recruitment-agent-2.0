...
class JDTemplate(Base, TimestampMixin):
    ...
    template_id: Mapped[str] = mapped_column(String(50), primary_key=True, default=generate_uuid)
...
class JD(Base, TimestampMixin):
    ...
    jd_id: Mapped[str] = mapped_column(String(50), primary_key=True, default=generate_uuid)
    ...
    template_id: Mapped[str | None] = mapped_column(String(50), ForeignKey("jd_templates.template_id"), nullable=True)
